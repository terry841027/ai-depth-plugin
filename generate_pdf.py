...
# ── Title ──────────────────────────────────────────────────────────────────
story.append(Paragraph("AI Depth Map Plugin", title_style))
story.append(Paragraph("使用說明與功能介紹", h2_style))
story.append(Spacer(1, 0.3*cm))
story.append(Paragraph(
    "AI Depth Map 是一款即時單目深度估測 FFGL 插件，適用於 Resolume 及相容主機軟體。"
    "採用 Depth Anything V2 Small ONNX 模型，結合 GPU 加速推理與多種創意視覺化模式，"
    "適合現場 VJ 與視覺表演使用。",
    body_style
))
